...
## III. Review of PID in the time domain
...
![Distance and orientation of the car relative to the wall](img/wall_following_lab_figure_1.png){ width=50% }
...
![Finding the future distance from the car to the wall](img/wall_following_lab_figure_2.png){ width=50% }
...
Implement wall following to make the car drive autonomously around the Levine Hall map. Follow the inner walls of Levine. Which means follow left if the car is going counter-clockwise in the loop. You can implement this node in either C++ or Python.

## VI. Deliverables and Submission

**Deliverable 1**: After you're finished, update the entire skeleton package directory with your `wall_follow` package and upload the code to canvas.  A portion of the submissions will be peer reviewed by course staff to ensure that the code is academically honest. Your submitted code should start and run in simulation smoothly.

**Deliverable 2**: Make a screen cast of running your wall following node in the simulation. This should also be uploaded to canvas on the assignment page. 

>>>>>>> f54acce (Add wall following lab code)
