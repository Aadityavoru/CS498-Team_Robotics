...
**Artificial Intelligence Disclosure**: If you used any generative AI tools to complete this assignment, you must disclose that you used them and how in the canvas comment section for the submission. 
...
You can implement this package in either python or c++, and skeleton code has been provided in the zip file attached to this assignment page. 
